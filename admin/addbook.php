                    ...
                    <div class="span3">
                        <div class="sidebar">
                           <ul  class="widget widget-menu unstyled">
                                ...
                                <li><a href="addbook.php" class="active"><i class="menu-icon icon-edit"></i>Add Books </a></li>
                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            <div style="background-color: #003366;" class="module-head">
                                <h3 style="color: white;">Add Book</h3>
                            </div>
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="addbook.php" method="post">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="acno"><b>FromAccNo</b></label>
                                            <div class="controls">
                                                <input type="text" id="acno" name="FromAccNo" placeholder="From Account Number" class="span8" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="acno"><b>ToAccNo</b></label>
                                            <div class="controls">
                                                <input type="text" id="acno" name="ToAccNo" placeholder="To Account Number" class="span8" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="noofpages"><b>No Of Pages</b></label>
                                            <div class="controls">
                                                <input type="number" id="noofpages" name="NoOfPages" placeholder="No Of Pages" class="span8" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="department" name="Department" placeholder="Department" class="span8" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="Supplier"><b>Supplier</b></label>
                                            <div class="controls">
                                                <input type="text" id="Supplier" name="Supplier" placeholder="Supplier" class="span8" required>
                                            </div>
                                        </div>

                                    <div class="control-group">
                                            <label class="control-label" for="volume"><b>Volume</b></label>
                                            <div class="controls">
                                                <input type="text" id="volume" name="Volume" placeholder="Volume" class="span8" required>
                                            </div>
                                        </div>
...
$sql1="insert into jntugv_library.books (Title,Author,Publisher,Year,NoOfPages,Department,Supplier,Volume,FromAccNo,ToAccNo,Edition) values ('$title','$author','$publisher','$year','$pages','$dept','$supp','$vol','$fan','$tan','$edition')";
