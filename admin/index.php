        ...
        <div class="wrapper" >
            <div class="container">
                <div class="row">
                    <div  class="span3"   >
                        <div  class="sidebar">
                            <ul  class="widget widget-menu unstyled">
                               ...
                               <!-- <li><a href="details.php"><i class="menu-icon icon-tasks"></i>Library Details</a></li>-->
                    ...
                    <div class="span9">
                        <center>
                            <div class="card" style="width: 50%;margin-top: 50px;"> 
                                ...
                                $sql="select * from jntugv_library.users where MemberID='$id'";
