                        ...
                        <div class="sidebar">
                            <ul  class="widget widget-menu unstyled">
                               ...
                               <li><a href="issue_requests.php"><i class="menu-icon icon-tasks"></i>Book Issue</a></li>
                                <li><a href="return_requests.php" class="active"><i class="menu-icon icon-tasks"></i>Book Return</a></li>
                   ...
                   <div class="span9">
                        <div class="module">
                            <div style="background-color: #003366;" class="module-head">
                                <h3 style="color: white;">Book Return/Renewal</h3>
                            </div>
                            <div class="module-body">
                                ...
                                <form class="form-horizontal row-fluid" action="return_requests.php" method="post">
                             ...
                             $sql2="select * from jntugv_library.bookissues where MemberID='$rollno'";
                        ...
                        <table class="table" id = "tables">
                            ...
                            while($row2=$result2->fetch_assoc())
                            {
                                ...
                                $sql3="select Volume from jntugv_library.books where FromAccNo='$acc' or Title='$name' and Author='$author'";
                                      ...
                                      <td><?php echo $vol ?></td>
                                       ...
                                       <td><center>
                                        ...
                                        <?php
                                         ...
                                         echo "<a href=\"acceptreturn.php?id1=".$name."&id2=".$rollno."&id3=".$author."&id4=".$acc."\" class=\"btn btn-success\">Return</a>";
                                         echo "<a href=\"acceptrenewal.php?id1=".$name."&id2=".$rollno."&id3=".$author."&id4=".$acc."\" class=\"btn btn-success\">Renewal</a>";
                                         ?>
