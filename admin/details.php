        ...
        <div class="wrapper" >
            <div class="container">
                <div class="row">
                    <div  class="span3"   >
                        <div  class="sidebar">
                            <ul  class="widget widget-menu unstyled">
                                ...
                                <li><a href="details.php" class="active"><i class="menu-icon icon-tasks"></i>Library Details</a></li>
                    ...
                    <div class="span9">
                        <center>
                            <div class="card" style="margin-top: 50px;width: 400px;"> 
                                <!--<img class="card-img-top" src="images/profile2.png" alt="Card image cap">-->
                                <div style="background-color: white;border-radius: 2px;box-shadow: 5px 10px 5px 5px #888888" class="card-body">


                               <div   class="card child" > 
                                <!--<img class="card-img-top" src="images/profile2.png" alt="Card image cap">-->
                                <div style="background-color: #03a9f4;border-radius: 2px;box-shadow: 5px 5px 5px 5px #888888" class="card-body">
                            ...
                            <div  style="margin-left: 30px;" class="card  child" > 
                                <!--<img class="card-img-top" src="images/profile2.png" alt="Card image cap">-->
                                <div style="background-color: #03a9f4;border-radius: 2px;box-shadow: 5px 5px 5px 5px #888888" class="card-body">
