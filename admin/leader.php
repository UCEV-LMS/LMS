                ...
                <div class="row">
                    <div class="span3">
                        <div class="sidebar">
                            <ul  class="widget widget-menu unstyled">
                                ...
                                <li><a href="leader.php" class="active" ><i  class="menu-icon icon-home"></i>LeaderBoard
                                </a></li>
                    ...
                    <div class="span9">
                        ...
                        $dbpassword = "";
                            ...
                            $query1 = mysqli_query($conn, "SELECT * FROM jntugv_library.users where Type='Faculty' ORDER BY Points DESC LIMIT 3 ");
