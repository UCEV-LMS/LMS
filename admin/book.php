                  ...
                  <form class="form-horizontal row-fluid" action="book.php" method="post">
                        ...
                        <table class="table" id = "tables">
                            ...
                            while($row=$result->fetch_assoc())
                            {
                                ...
                                $sql4="select DateOfReturn from jntugv_library.bookissues where Title='$name' and Author='$author'";
                            ...
                            ?>
                                    <tr>
                                     ...
                                     <!-- <td><b><?php echo $avail ?></b></td>-->
                                        <td><center>
                                          <?php
                                            echo "<a href=\"bookdetails.php?id1=".$name."&id2=".$acc."\"class=\"btn btn-primary\">Details</a>";
                                            echo "<hr>";
                                            echo "<a href=\"edit_book_details.php?id1=".$name."&id2=".$acc."\"class=\"btn btn-success\">Edit</a>";
                                            ?>
                                        </center></td>
                                    </tr>
                               <?php }} ?>
